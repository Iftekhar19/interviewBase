  ...
  return (
    <section className="py-20 px-6 md:px-20 bg-white dark:bg-gray-950">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <motion.p
          className="text-md md:text-lg mb-8 max-w-2xl mx-auto text-gray-700 dark:text-gray-300"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
        >
          Join our vibrant community of developers helping each other succeed —
          whether you're posting questions or browsing answers.
        </motion.p>
        <motion.div
